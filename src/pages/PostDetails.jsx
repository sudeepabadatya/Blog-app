...
<span className="text-xs px-2 py-1 rounded-full bg-gray-100 dark:bg-gray-800">{post.category}</span>
</div>
...
<Link to={`/edit/${post.id}`} className="px-3 py-2 rounded-xl border">Edit</Link>
<button
onClick={() => {
deletePost(post.id);
navigate('/');
